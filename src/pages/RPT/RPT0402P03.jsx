...
import { TD_RPT0402M01_01, TD_RPT0402M01_02, TD_RPT0402P03_Sub } from '../../data/tableDatas';
...
const RPT0402P03 = ({ user }) => {
  ...
  return (
    <S.Wrap>
      ...
      <WOModal isOpen={isModalOpen3} direction='center' size='xl' bgColor='white' title='세출일계표' onClose={() => setIsModalOpen3(false)}>
        <ModalContentArea gap={20}>
          <WOSubTable tableData={TD_RPT0402P03_Sub} type='modal' />
