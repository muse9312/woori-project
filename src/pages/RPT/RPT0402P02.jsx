...
import { TD_RPT0402M01_01, TD_RPT0402M01_02, TD_RPT0402P02_Sub } from '../../data/tableDatas';
...
const RPT0402P02 = ({ user }) => {
  ...
  return (
    <S.Wrap>
      ...
      <WOModal isOpen={isModalOpen3} direction='center' size='xl' bgColor='white' title='세입세출외현금 자금일계표' onClose={() => setIsModalOpen3(false)}>
        <ModalContentArea gap={20}>
          <WOSubTable tableData={TD_RPT0402P02_Sub} type='modal' />
