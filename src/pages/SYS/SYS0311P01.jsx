...
import { TD_SYS0311M01, TD_SYS0311P01 } from '../../data/tableDatas';
      ...
      <WOModal isOpen={isModalOpen} title={'코드그룹목록세부'} size='xl' onClose={() => setIsModalOpen(false)}>
        <ModalContentArea>
          <S.TableBox>
            ...
            <WOTable tableData={TD_SYS0311P01} hasStateBar={true} stateBarHeader={'신규/수정'} height={294} noneIndicator={true} />
          </S.TableBox>
          <WOBottomSheet
            type='modal'
            title={'코드그룹목록 입력/수정'}
