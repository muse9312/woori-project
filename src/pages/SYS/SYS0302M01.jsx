...
import { TD_SYS0302M01 } from '../../data/tableDatas';
        ...
        <S.ContentWrap>
          ...
          <S.ViewArea>
            <S.TableBox>
              ...
              <WOTable tableData={TD_SYS0302M01} hasStateBar={true} noneIndicator={true} stateBarHeader={'신규/수정'} />
            </S.TableBox>
          </S.ViewArea>
          ...
          <WOBottomSheet
            ...
            <WOSearchArea noneBtn={true} type='modal'>
              <WOFormColumn>
                <WOInput label='사이트 명' value='세무관리' />
              </WOFormColumn>
              <WOFormColumn>
