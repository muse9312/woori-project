        ...
        <S.ContentWrap>
          ...
          <S.ViewArea>
            <S.TableBox>
              ...
              <WOTable tableData={TD_SYS0301M01} hasStateBar={true} stateBarHeader={'신규/수정'} />
            </S.TableBox>
          </S.ViewArea>
          ...
          <WOBottomSheet
            ...
            <WOSearchArea noneBtn={true} type='modal'>
              <WOFormColumn>
                <WOComboBox label={'구분'} optionList={[{ id: 1, label: '시스템공통' }]} isAutoComplete={true} />
              </WOFormColumn>
              <WOFormColumn>
