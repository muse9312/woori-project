        ...
        <WOTabContent id={1} activeTabId={activeTabID}>
          <S.ContentWrap>
            ...
            {checkedItem === 1 && (
              <S.ViewArea>
                <S.TableBox>
                  <WOTable tableData={TD_ZPB0101V01_1} hasCheckBar={true} />
                </S.TableBox>
              </S.ViewArea>
            )}
            {checkedItem === 2 && (
              <S.ViewArea>
                <S.TableBox>
                  <WOTable tableData={TD_ZPB0101V01_2} hasCheckBar={true} />
                </S.TableBox>
              </S.ViewArea>
            )}
          </S.ContentWrap>
          ...
          <S.ContentWrap>
            ...
            <S.ViewArea>
              <S.TableBox>
                ...
                <WOTable tableData={TD_ZPB0101V02} hasCheckBar={true} checkBarHeader='카카오톡 전송' checkBarWidth={100} indicatorReverse={true} />
              </S.TableBox>
            </S.ViewArea>
          </S.ContentWrap>
        </WOTabContent>
