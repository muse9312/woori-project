...
import { ZPB_02_breadCrumbList, TD_ZPB0207M01, recipientOptionList, recipientDetailOptionList, selectTypeList, selectTimeList } from '../../data/response';
...
const ZPB0207P03 = () => {
  // logic
  const [isRegitrationModal, setIsRegitrationModal] = useState(false);
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div className='flex-box'>
                    <WOFormColumn width={320}>
                      <WOComboBox optionList={selectTimeList} defaultValue={selectTimeList[1]} onChange={handleTimeChange} isAutoComplete={true} />
                    </WOFormColumn>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colSpan={3}>
                  <div className='flex-box'>
                    <WOFormColumn width={320}>
                      <WOComboBox optionList={[{ id: 1, label: 'Y' }]} isAutoComplete={true} />
                    </WOFormColumn>
                  </div>
                </td>
              </tr>
          ...
          <WOEditTable>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div className='flex-box'>
                    <WOFormColumn width={320} isAlignCenter={true}>
                      <WOCheckbox
                        blind
                        item={{
                          id: 'input04',
                        ...
                        readonly={!isDetailEditable}
                      />
                      {/* <WOComboBox optionList={[{ id: 1, label: '00시' }]} isAutoComplete={true} readonly={!isDetailEditable} />
                    <WOComboBox optionList={[{ id: 1, label: '00시' }]} isAutoComplete={true} readonly={!isDetailEditable} /> */}
                    </WOFormColumn>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td colSpan={3}>
                  <div className='flex-box'>
                    <WOFormColumn width={320}>
                      <WOComboBox optionList={[{ id: 1, label: 'Y' }]} isAutoComplete={true} disabled={!isDetailEditable} />
                    </WOFormColumn>
                  </div>
                </td>
              </tr>
