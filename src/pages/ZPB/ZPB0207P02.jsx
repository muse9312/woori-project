...
const ZPB0207P02 = () => {
  ...
  // 종일알림여부
  const [selectTimeItem, setSelectTimeItem] = useState(selectTimeList[0]);
                ...
                <tr>
                  ...
                  <td colSpan={3}>
                    <div className='flex-box'>
                      <WOFormColumn width={320}>
                        <WORadioGroup
                          radioItems={selectAppVersionList}
                          defaultCheckedValue={selectAppItem}
