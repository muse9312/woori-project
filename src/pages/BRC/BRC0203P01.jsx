...
const BRC0203P01 = () => {
  ...
  return (
    <S.Wrap>
      ...
      <WOModal direction='center' size='xl' isOpen={isOpenModal} title={'지자체 정보 상세 '} onClose={() => setIsOpenModal(false)}>
        {/* START: modalContent */}
        <ModalContentArea>
          {/* 기본 정보 */}
          <S.TableBox>
            ...
            <WOEditTable>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colSpan='3'>
                    <WOTextArea height={64} placeholder={''} value='0억 만기 도래에 따라 재예치함' readonly={true} />
                  </td>
                </tr>
                <tr>
                  <th>지자체 금고 입찰 정보</th>
                  <td colSpan='3'>
                    <WOTextArea height={64} placeholder={''} value='-' readonly={true} />
                  </td>
                </tr>
                <tr>
                  <th>지자체 타행 동향 등</th>
...
기금권한부여요청드립니다.'
          ...
          <S.TableBox>
            <S.ModalTitleWrap>
              ...
              <div className='btn-wrap'>
                <WOButton onClick={() => {}} variant='outlined' color={'#ff5d5d'} disabled>
                  파일 삭제
                </WOButton>
                <WOButton onClick={() => {}} variant='outlined' disabled>
                  파일 첨부
                </WOButton>
              </div>
            </S.ModalTitleWrap>
          ...
          <WOBottomSheet type='modal'>
            <WOSearchArea noneBtn={true} type='modal'>
              <WOFormColumn>
                <WOComboBox label={'평가점수'} optionList={[{ id: 1, label: '-' }]} isAutoComplete={true} disabled={true} />
              </WOFormColumn>
            </WOSearchArea>
          </WOBottomSheet>
        </ModalContentArea>
