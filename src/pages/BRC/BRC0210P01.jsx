    ...
    <S.Wrap>
      ...
      <S.Main>
        ...
        <S.ContentWrap>
          ...
          <S.ViewArea>
            <S.TableBox>
              <WOTable tableData={TD_BRC0210V01} />
            </S.TableBox>
          </S.ViewArea>
        </S.ContentWrap>
      </S.Main>
      ...
      <WOModal direction='center' size='xl' isOpen={isOpenModal} title={'공금업무 제안광장 상세 '} onClose={() => setIsOpenModal(false)}>
        {/* START: modalContent */}
        <ModalContentArea>
          <S.TableBox>
            <S.ModalTitleline />
            <S.ModalTitleWrap>
              ...
              <div className='btn-wrap'>
                <WOFormColumn>
                  <WOComboBox label={'답변상태'} optionList={[{ id: 1, label: '접수' }]} isHorizontal='true' isAutoComplete={true} />
                </WOFormColumn>
              </div>
            </S.ModalTitleWrap>
            <WOEditTable>
              ...
              <tbody>
                  ...
                  <td>
                    <div className='flex-box'>
                      <WOFormColumn width={320} col={3} gap={0}>
                        <WOComboBox optionList={[{ id: 1, label: '통합금고업무' }]} isAutoComplete={true} readonly={true} />
                      </WOFormColumn>
                    </div>
                  </td>
                </tr>
                <tr>
                  <th>제목</th>
                  <td colSpan='3'>
                    <WOInput id='input01' name='input01-01' value='처리관련' readonly={true} />
                  </td>
                </tr>
              </tbody>
            </WOEditTable>
            ...
            <WOEditTable>
              <tbody>
                <tr>
                  <th>문제점</th>
                  <td colSpan='3'>
                    <WOTextArea height={64} placeholder={'이러한 경우가 종종 있습니다.'} value='0억 만기 도래에 따라 재예치함' readonly={true} />
                  </td>
                </tr>
              </tbody>
            </WOEditTable>
            ...
            <WOEditTable>
              <tbody>
                <tr>
                  <th>제안 사항</th>
                  <td colSpan='3'>
                    <WOTextArea height={64} placeholder={'이렇게 하면 되지 않을까 싶습니다.'} value='-' readonly={true} />
                  </td>
                </tr>
              </tbody>
            </WOEditTable>
