      ...
      <S.Main>
          ...
          <S.ContentWrap>
            <S.SearchArea>
              <WOSearchArea>
                ...
                <WOFormColumn>
                  <WOComboBox label={'신규/해지'} optionList={[{ id: 1, label: '0-전체조회' }]} isAutoComplete={true} disabled />
                </WOFormColumn>
              </WOSearchArea>
            </S.SearchArea>
            <S.ViewArea>
        ...
        <WOTabContent id={3} activeTabId={activeTabID}>
          <S.ContentWrap $heightAuto={true}>
            ...
            <S.ViewArea>
              <WOSubTable tableData={TD_FXP0101V03_Sub01} type='page' />
              <WOSubTable tableData={TD_FXP0101V03_Sub02} type='page' />
              <WOSubTable tableData={TD_FXP0101V03_Sub03} type='page' />
              <WOSubTable tableData={TD_FXP0101V03_Sub04} type='page' />
              <WOSubTable tableData={TD_FXP0101V03_Sub04_1} type='page' />
            </S.ViewArea>
          </S.ContentWrap>
        </WOTabContent>
      </S.Main>
      ...
      <SubFooter>
        ...
        {activeTabID === 2 && (
          <S.InnerFooter>
            ...
            <WOButton variant='outlined' size='lg' startIcon={<WOIcon icon={'print'} width={24} height={24} />} disabled={isModalOpen2}>
              출력
            </WOButton>
